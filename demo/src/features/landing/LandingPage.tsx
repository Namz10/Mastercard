...
import { Radar, CreditCard, ShieldCheck, BookOpen } from "lucide-react";
          ...
          <section className="landing-content flex flex-col justify-center px-6 py-12 lg:px-12 lg:py-0 min-h-[min(46vh,440px)] lg:min-h-full">
            <div className="relative z-[2] max-w-[36rem] mx-auto lg:mx-0 w-full">
              ...
              <ol className="mt-9 flex flex-col gap-2.5 sm:gap-3">
                {LOOP_STEPS.map((phase, i) => {
                  const Icon = phase.icon;
                  return (
                    <FadeContent key={phase.label} delay={i * 120}>
                      <li className="landing-step group">
              ...
              <div className="mt-6 flex flex-wrap gap-4 text-[13px] text-ink-muted">
                <span><CountUp value={24} className="font-medium text-ink tnum" /> techniques</span>
                <span><CountUp value={398431} className="font-medium text-ink tnum" /> events</span>
                <span><CountUp value={98.52} decimals={1} suffix="%" className="font-medium text-ink tnum" /> recall</span>
              </div>
              ...
              <div className="mt-10 flex flex-wrap items-center gap-3">
                ...
                <Link to="/how-it-works" className="landing-btn-ghost flex items-center gap-1.5">
