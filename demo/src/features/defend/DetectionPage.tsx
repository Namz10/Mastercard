...
import { BootstrapFamilyChips } from "@/components/ui/BootstrapFamilyChips";
    ...
    >
      ...
      {!session.generate.runId ? (
        ...
        <div className="flex-1 flex flex-col min-h-0 gap-2">
          ...
          <PipelineDiagram
            mode="fit"
            activeVerb={narration?.verb}
            activeBody={narration?.happening}
          />
          <BootstrapFamilyChips
            family={narration?.artifacts?.family as string | undefined}
            resample={narration?.artifacts?.resample as number | undefined}
          />
          <JobThread
